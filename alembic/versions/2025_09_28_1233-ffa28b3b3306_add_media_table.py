...
def upgrade() -> None:
    ...
    sa.Column('media_type', sa.String(length=50), nullable=True, comment='Type of media (IMAGE, VIDEO, CAROUSEL_ALBUM)'),
    ...
    sa.Column('raw_data', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='Raw Instagram API response data'),
    sa.PrimaryKeyConstraint('id')
    )
    op.alter_column('instagram_comments', 'conversation_id',

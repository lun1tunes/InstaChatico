"""
Client document model for storing business context documents.
...
class ClientDocument(Base):
    ...
    # Table constraints
    __table_args__ = (
        # Prevent duplicate documents per client
        Index(
            "idx_client_document_unique",
            "client_id",
            "content_hash",
            unique=True,
    ...
    def __repr__(self) -> str:
        return f"<ClientDocument(id={self.id}, name={self.document_name}, status={self.processing_status})>"
